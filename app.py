...
def concepts():
    ...
    if mon == "toan":
        concepts = ["dao_ham", "nguyen_ham", "logarit", "cap_so_cong", "cap_so_nhan", "nhan_xac_xuat", "xac_suat_co_dieu_kien", "xac_suat_toan_phan_va_bayes", "xac_suat", "vector", "toa_do_hoa_hinh_hoc", "tich_phan", "so_phuc", "tiem_can", "hinh_hoc_oxyz"]
    else:
